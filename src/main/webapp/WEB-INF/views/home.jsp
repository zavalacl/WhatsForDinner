...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/css/creative.min.css"
	type="text/css" />
<!-- Custom CSS -->
<link rel="stylesheet"
...
<script src="${pageContext.request.contextPath}/resources/js/forms.js">
	...
	<nav id="mainNav" class="navbar navbar-default navbar-fixed-top">
		...
		<div class="container-fluid">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand page-scroll" href="#page-top">Dinner
					Ninja</a>
			</div>
			...
			<div class="header-content-inner">
				...
				<form name="signIn" action="signIn" method="GET">
					...
					<br>Email:<input type="text" name="eml"> <br>Password:<input
						type="password" name="pass"> <br> <input
						class="btn btn-primary btn-xl" type="submit" value="sign in">
	...
	<section class="no-padding" id="portfolio">
		<div class="container-fluid">
			<div class="row no-gutter popup-gallery">
				...
				<div class="col-lg-4 col-sm-6">
					<a href="img/portfolio/fullsize/4.jpg" class="portfolio-box"> <img
				...
				<div class="col-lg-4 col-sm-6">
					<a href="img/portfolio/fullsize/5.jpg" class="portfolio-box"> <img
				...
				<div class="col-lg-4 col-sm-6">
					<a href="img/portfolio/fullsize/6.jpg" class="portfolio-box"> <img
